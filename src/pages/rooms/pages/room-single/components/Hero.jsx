import { roomSingleHero } from "../../../../../data/rooms"
...
const Hero = () => {
	return (
		<section
			...
			style={{
				background: `rgba(0,0,0,0.5) url(${roomSingleHero}) no-repeat`,
		...
		>
			<div className='space-y-6 md:w-[650px] lg:w-[590px]'>
				<h1 className='show-on-scroll font-black text-4xl sm:text-5xl md:text-6xl'>Family Rustic Cabin</h1>
