...
const PostCard = ({ img, details }) => {
	...
	return (
		<div
			className='transition-all duration-300 ease-in-out group border shadow-lg rounded-xl cursor-pointer my-10 md:w-[48%]'
			onClick={() => {
				navigate("/blog-post")
			}}
		...
		>
			...
			<div className='space-y-5 px-8 py-12 sm:h-[380px] lg:h-auto'>
				<p className="text-lg text-gray-500">{details.date}</p>
