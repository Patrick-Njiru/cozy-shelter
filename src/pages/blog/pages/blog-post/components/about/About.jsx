		...
		<section className='mt-12 text-lg leading-loose'>
			<div className='relative flex flex-col space-y-8 justify-start px-6 sm:px-10 md:px-16 lg:space-y-0 lg:flex-row lg:justify-between'>
				<div className='space-y-8 lg:w-[66%]'>
					<h1 className='text-3xl md:text-5xl font-bold'>{title1}</h1>
					...
					<h2 className='text-2xl md:text-4xl font-bold'>{title2}</h2>
					<p className='text-gray-600'>
					...
					<img src={img2} alt='glamping' className='w-full rounded-3xl' />
					<p className='text-gray-600'>
					...
					<h4 className='text-lg md:text-2xl font-bold'>{title4}</h4>
					<p className='text-gray-600'>
					...
					<div className='block px-20 py-24 border shadow rounded-3xl text-xl md:text-2xl'>
						<q>{quote}</q>
					</div>
					<h5 className='md:text-xl font-bold'>{title5}</h5>
					<p className='text-gray-600'>
