...
const Form = () => {
	return (
		<section className='px-6'>
			<form className='relative -top-80 border rounded-3xl bg-white p-10 mx-auto w-full shadow-xl space-y-6 md:p-20 md:w-[700px]'>
				<div className='flex flex-col space-y-6 justify-between sm:flex-row sm:space-y-0'>
					<div className='flex flex-col space-y-3 md:w-[47%]'>
						<label
							htmlFor='name'
				...
				<div className='flex flex-col space-y-6 justify-between items-center sm:space-y-0 sm:flex-row'>
					<button
						type='submit'
						to='/about'
						className='inline transition-all duration-500 ease-in-out bg-red-500 text-white px-7 py-4 font-semibold w-fit rounded-full relative top-0 hover:bg-red-600 hover:-top-1 sm:text-lg sm:px-10 sm:py-6'
