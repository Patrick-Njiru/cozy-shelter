...
const ContactCard = ({ icon, purpose, contact }) => {
	return (
		<div className='show-on-scroll transition-all duration-500 ease-in-out relative top-0 group flex flex-col space-y-5 items-center mx-auto my-6 space-x-6 max-w-full hover:-top-2 hover:text-red-600 sm:flex-row sm:space-y-0 sm:w-80 md:w-[45%] lg:w-1/3'>
